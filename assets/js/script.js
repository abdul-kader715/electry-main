(function ($) {
    ...
    if ($('.electry-site-header .navigation').length) {
        cloneNavForSticyMenu($('.electry-site-header .navigation'), "sticky-header");
    }
    ...
    function stickyMenu($targetMenu, $toggleClass) {
        ...
        var mainMenuTop = $('.electry-site-header .navigation');
    ...
    /*------------------------------------------
        = Testimonial SLIDER
    -------------------------------------------*/
    if ($(".electry-testimonial-wrap").length) {
        $(".electry-testimonial-wrap").owlCarousel({
            autoplay: false,
            smartSpeed: 300,
            margin: 20,
            loop: true,
    ...
    /*------------------------------------------
        = Testimonial SLIDER
    -------------------------------------------*/
    if ($(".electry-service-slider").length) {
        $(".electry-service-slider").owlCarousel({
            autoplay: false,
            smartSpeed: 300,
            margin: 20,
            loop: true,
    ...
    /*------------------------------------------
        = Testimonial SLIDER
    -------------------------------------------*/
    if ($(".electry-happy-client-slide").length) {
        $(".electry-happy-client-slide").owlCarousel({
            autoplay: true,
            smartSpeed: 300,
            margin: 0,
            loop: true,
    ...
    if ($("#contact-form-main").length) {
        $("#contact-form-main").validate({
            ...
            messages: {
                ...
                adress: "Please enter your phone number",
    ...
    $(window).on("scroll", function () {
        ...
        if ($(".electry-site-header").length) {
            stickyMenu($('.electry-site-header .navigation'), "sticky-on");
        }
